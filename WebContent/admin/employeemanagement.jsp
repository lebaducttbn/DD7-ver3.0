      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-title">
              <a style="background-color: green"  class="nav-link manager-category" data-set=".main-employee-manager" href="employeemanagement.html">
      ...
      <main class="main">
        <!-- Breadcrumb-->
        	...
        	<div class="main-content main-employee-manager">
            	<h2 classs="breadcrumb breadcrumb-item">Quản lý nhân viên</h2>
              ...
              <div class="col-lg-12">
                ...
                <button type="submit" class="btn btn-danger">Xóa các nhân viên</button>
                <a href="add-product.html" target="_blank"><button class="btn btn-success">Thêm nhân viên</button></a>
                </div>
              </div>
            </div>          
          </div>
