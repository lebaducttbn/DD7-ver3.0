    ...
    <div class="app-body">
      ...
      <main class="main">
  		<div class="main-content main-product-manager">
            <h2 class="breadcrumb breadcrumb-item">Sửa Tour</h2>
        	<div class="row">
        		<div class="col-lg-4">
        			<h6>Miền</h6>
        		...
        		<div class="col-lg-4">
       			  <h6>Giá tiền</h6>
        			<input value="100.000 VNĐ" type="text" class="form-control" name="" />
        		</div>
        		<div class="col-lg-4">Tên Tour
        		  <select class="form-control">
   				    <option>Hoa Lư</option>
        				<option>Văn Lang</option>
        			</select>
        		</div>
        		<div class="col-lg-4">
        			<h6>Số lượng</h6>
        			<input value="100" type="text" class="form-control" name="" />
        		</div>
        		<div class="col-lg-4">
        			<h6>&nbsp;</h6>
        		</div>
        	...
        	<div class="row btn-edit-product">
    			<div class="col-lg-12">
